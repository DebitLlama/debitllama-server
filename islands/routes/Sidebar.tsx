    ...
    return <div id="sidebar-id" class={`select-none sidebarheight fixed z-20 flex flex-col left-0 bg-white border-r ${collapse ? "collapsed" : ""}`}>
        <div class="overflow-y-auto overflow-x-hidden flex-grow">
            <ul class="flex flex-col py-4 space-y-1 whitespace-nowrap">
                ...
                <li>
                    <a href="/app/manage_api/rest" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50  hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6">
                        <span class="inline-flex justify-center items-center ml-4">
                        ...
                        <span class="ml-2 text-sm tracking-wide truncate">API</span>
                    </a>
                </li>
                <li>
                ...
                <li>
                    <a href="/app/webauthn/2fa" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50  hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6">
                        <span class="inline-flex justify-center items-center ml-4">

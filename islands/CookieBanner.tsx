...
export default function CookieBanner() {
    ...
    const acceptCookies = () => {
        setCookiesAcceptedToSS();
        setShowBanner(false);
    }

    useEffect(() => {
        setShowBanner(!getCookiesAcceptedFromSS())
    }, [])


    return <div class={`flex flex-row justify-center w-full`}>
        <div class={`z-10 fixed max-w-sm p-4 mt-5 mx-auto text-center bg-white border border-gray-200 md:gap-x-4 bottom-14 dark:bg-gray-900 md:flex md:items-center dark:border-gray-700 rounded-2xl ${showBanner ? "show" : "hide"}`}>
            <div class="flex items-center gap-x-4">
                ...
                <p class="text-sm text-gray-600 dark:text-gray-300">We use cookies to ensure you stay logged in. <a href="/privacyPolicy" class="text-indigo-500 hover:underline">Read cookies policies</a>. </p>
            </div>

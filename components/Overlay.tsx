...
export default function Overlay(props: {
    ...
    const error = <div class="p-10 bg-white w-64  mx-auto border shadow-md rounded-lg text-center flex flex-col justify-center">
        ...
        <button aria-label="Press ok button" type={"button"} onClick={props.error.action} class=" mx-auto mt-2 w-full text-white bg-indigo-500 hover:bg-indigo-600 focus:ring-4 focus:outline-none focus:ring-indigo-300 font-medium rounded-lg text-lg text-center dark:bg-indigo-600 dark:hover:bg-indigo-700 dark:focus:ring-indigo-800">Ok</button>
    </div>

...
export function LoggedOutUi(props: LoggedOutUiProps) {
    ...
    return <div class="pb-3 max-w-sm mx-auto">
        ...
        <form class="space-y-4 md:space-y-6" method="POST">
            ...
            <button aria-label={"Log in button"} type="submit" class="w-full text-white bg-indigo-500 hover:bg-indigo-600 focus:ring-4 focus:outline-none focus:ring-indigo-300 font-medium rounded-lg text-2xl px-5 py-2.5 text-center dark:bg-indigo-600 dark:hover:bg-indigo-700 dark:focus:ring-indigo-800">Log In</button>

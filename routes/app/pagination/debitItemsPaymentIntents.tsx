...
import { selectPaymentIntentsByPayeeUserIdPaginated, selectPaymentIntentsByPayeeUserIdPaginatedWithSearch } from "../../../lib/backend/db/tables/PaymentIntents.ts";
...
export const handler: Handlers<any, State> = {
    async POST(_req, ctx) {
        ...
        if (searchTerm === "") {
            const { data: piRows, count } = await selectPaymentIntentsByPayeeUserIdPaginated(ctx, {
                order,
            ...
            const { data: piRows, count } = await selectPaymentIntentsByPayeeUserIdPaginatedWithSearch(ctx, {
                order,
                ascending: sortDirection === "ASC",
                rangeFrom: from,
                rangeTo: to,
